...
<script type="text/javascript">
	function checkForm(){
		...
		var actestPlaceId=document.getElementById("actestPlaceId").value;
		var actestStatus=document.getElementById("actestStatus").value;
		var name=document.getElementById("name").value;
		var sex=document.getElementById("sex").value;
		var tel=document.getElementById("tel").value;
		if(userName==""||password==""||rPassword==""||name==""||sex==""||tel==""||actestPlaceId==""||actestStatus==""){
			...
			<div class="data_form" >
				<input type="hidden" id="studentId" name="studentId" value="${student.studentId }"/>
					<table align="center">
						...
						<tr>
							<td><font color="red">*</font>核酸地点：</td>
							<td>
								<select id="actestPlaceId" name="actestPlaceId" style="width: 90px;">
									<c:forEach var="actestPlace" items="${ActestPlaceList }">
										<option value="${actestPlace.actestPlaceId }" ${student.actestPlaceId==actestPlace.actestPlaceId?'selected':'' }>${actestPlace.actestPlaceName }</option>
									</c:forEach>
								</select>
							</td>
						</tr>
						<tr>
							<td><font color="red">*</font>核酸情况：</td>
							<td><input type="text" id="actestStatus"  name="actestStatus" value="${student.actestStatus }"  style="margin-top:5px;height:30px;" /></td>
						</tr>
						<tr>
