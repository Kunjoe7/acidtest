...
<style type="text/css">
	body {
		background-image: linear-gradient(to right, #fcc7c2, #dabff8);
	}
	.bs-docs-sidenav {
		background-image: linear-gradient(to right, #fcc7c2, #dabff8);
		border-radius: 6px;
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><span style="color:white; font-size: 3em;" >核酸管理系统</span></div>
